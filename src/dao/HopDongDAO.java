...
public class HopDongDAO extends DataProvider {
	...
	public void themKhachHang(int maKH, String tenKhachHang, int gioiTinh,
			int soCMND, String diaChi) {
		String querry = "insert into KhachHang values(" + maKH + ",N'"
				+ tenKhachHang + "'," + gioiTinh + ",'" + soCMND + "',N'"
				+ diaChi + "')";
		try {
			exU(querry);
