					...
					<ul>	<!-- SLIDE  -->
						...
						<li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on"  data-title="Parallax 3D">
							...
							<div class="tp-caption finewide_medium_white customin tp-resizeme rs-parallaxlevel-0"
								...
								<div style="color:blue;font-family:Time New Roman;"> GIẢM LÃI SUẤT 2 % CHO TẤT CẢ LOẠI TÀI SẢN</div>
							</div>
						</li>
					</ul>
				...
				<div id="bookshelf" class="bookshelf products-box">
					...
					<logic:present name="hangThanhLyForm" property="listTL">
						<logic:iterate id="tl" name="hangThanhLyForm" property="listTL">
							<figure class="product-post" style="padding:0 0;background: #f9f6f6;">
								<div class="book" data-book="book-1" style="background-image: url(<bean:write name="tl" property="hinhAnh"/>);
																		    padding: 0;
																		    margin: 0;
								...
								<div class="buttons"><a href="#">Chi Tiết</a></div>
								<span><bean:write name="tl" property="tenTaiSanThanhLy"/></span>
								<div class="product-links">
									<span style="font-size: 22px;"><b>Giá: </b><bean:write name="tl" property="soTienThanhLy"/></span>
								</div>
							</figure>
						</logic:iterate>
					</logic:present>
					...
					<div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
						<ul class="pagination">
							<li class="paginate_button" aria-controls="dataTables-example" tabindex="0">
								<logic:present name="hangThanhLyForm" property="pages">
                                	<logic:iterate name="hangThanhLyForm" property="pages" id="a">
										<html:link action="/thanh-ly-tai-san.do" paramName="a" paramId="page">
										<bean:write name="a" />
									</html:link>
									</logic:iterate>
                                </logic:present>
		    ...
		    <div class="modal-dialog">
		      ...
		      <div class="modal-content">
		        ...
		        <div class="modal-body" style="padding:40px 50px;">
		          <html:form action="/thanh-ly-tai-san" method="post" acceptCharset="UTF-8">
		            <div class="form-group">
		              <label for="usrname"><span class="fa fa-user" aria-hidden="true"></span> Tài Khoản</label>
		              <html:text property="taiKhoan" styleClass="form-control" styleId="tkhoan"></html:text>
		            </div>
		            <div class="form-group">
		              <label for="psw"><span class="fa fa-eye" aria-hidden="true"></span> Mật Khẩu</label>
		              <html:password property="matKhau" styleClass="form-control" styleId="mkhau"></html:password>
		        ...
		        <div class="modal-footer">
		        	<h6 style="text-align: center;color: red;"><html:errors/></h6>
		      </div>
		    </div>
		  </div>
		 </div>
